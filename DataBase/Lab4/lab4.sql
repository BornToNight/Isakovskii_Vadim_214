...
CREATE VIEW V_SUPPLY
  (CATERER_NAME, MATERIAL, SUPPLY_DATE, MESSURE, PRICE, VOLUME, SUMM)
AS
  SELECT T_CATERER.NAME, T_MATERIAL.NAME, T_MESSURE.NAME, T_SUPPLY.SUPPLY_DATE, T_INPRICE.PRICE, T_SUPPLY.VOLUME, T_SUPPLY.VOLUME * T_INPRICE.PRICE
...
-- 52 При создание таблицы не было сказано про "цены поставок"
